      ...
      {information.map((info, index) => {
        ...
        return (
          <li key={index} className="flex items-center even:justify-end">
            <div className="flex items-center gap-4 bg-white/5 max-w-3xl w-full h-20 px-4 rounded-2xl border border-[#393939] xs:border-2 xs:rounded-3xl xs:px-8 sm:gap-5">
