      ...
      <div className="pt-24 pb-20 md:pt-12">
        <div className="container relative">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-5 md:grid-cols-4 lg:grid-cols-5">
            {/* 1 */}
            <div className="w-full h-72 rounded-3xl overflow-hidden order-1 xs:h-80 sm:h-96">
              <img
                width={226}
                height={384}
                src={statsBg}
            ...
            {/* 3 */}
            <div className="flex flex-col justify-between w-full order-2 h-72 xs:h-80 sm:h-96 md:hidden md:order-3 lg:flex">
              {/* Rating */}
              ...
              {/* Bottom */}
              <div className="w-full h-44 bg-white space-y-3.5 p-6 rounded-3xl text-dark xs:p-8 xs:h-52">
            ...
            {/* 4 */}
            <div className="flex items-end w-full h-40 order-5 text-dark xs:h-52 md:h-96">
            ...
            {/* 5 */}
            <div className="flex flex-col items-start justify-end gap-3 w-full h-40 col-span-2 bg-primary p-6 rounded-3xl order-5 xs:gap-5 xs:p-8 xs:h-52 md:col-span-1 md:h-96">
              <img
                width={48}
                height={48}
                src={rocketIcon}
