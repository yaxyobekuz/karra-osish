    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="pt-20 pb-5 bg-red-5">
        <div className="container relative">
          {/* Title */}
          <h1 className="mb-5 text-center font-extrabold text-2xl px-5 sm:px-0 sm:text-3xl md:text-4xl lg:leading-relaxed lg:text-[44px]">
          ...
          {/* Description */}
          <p className="relative z-10 mb-8 text-center sm:text-[17px]">
            Biznesni yuksaltirish uchun kerakli dastur.{" "}
            <br className="md:hidden" /> Biz bilan biznesingizni rivojlantiring.
          </p>

          {/* Buttons */}
          <div className="flex flex-col items-center justify-center gap-5 w-full sm:flex-row">
            <a href="#develop" className="btn-primary w-40">
              Qabulga yozilish
            </a>
      ...
      <div className="hidden pt-24 pb-20 sm:block md:pt-12">
        <div className="container relative">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 sm:gap-5 md:grid-cols-4 lg:grid-cols-5">
            {/* 1 */}
            <div className="w-full h-72 rounded-2xl overflow-hidden order-1 xs:rounded-3xl xs:h-80 sm:h-96">
              <img
                width={226}
                height={384}
                src={statsBg}
            ...
            {/* 2 */}
            <div className="flex items-end w-full h-40 order-3 xs:h-52 sm:h-96 md:order-2">
              <div className="flex flex-col items-center justify-center gap-1.5 w-full h-full rounded-2xl bg-white/5 xs:rounded-3xl xs:gap-5 md:h-72">
            ...
            {/* 3 */}
            <div className="flex flex-col justify-between w-full order-2 h-72 xs:rounded-3xl xs:h-80 sm:h-96 md:hidden md:order-3 lg:flex">
              {/* Rating */}
              ...
              {/* Bottom */}
              <div className="w-full h-44 bg-white space-y-3.5 p-6 rounded-2xl text-dark xs:p-8 xs:h-52">
            ...
            {/* 4 */}
            <div className="flex items-end w-full h-40 order-5 text-dark xs:rounded-3xl xs:h-52 md:h-96">
              <div className="flex flex-col items-center justify-center gap-1.5 w-full h-full bg-[#E2FFC8] rounded-2xl xs:gap-5 md:h-72">
            ...
            {/* 5 */}
            <div className="flex flex-col items-start justify-end gap-3 w-full h-40 col-span-2 bg-primary p-6 rounded-2xl order-5 xs:rounded-3xl xs:gap-5 xs:p-8 xs:h-52 md:col-span-1 md:h-96">
              <img
                width={48}
                height={48}
                src={rocketIcon}
